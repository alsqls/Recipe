...
<%
	...
	try{
		...
		rs = stmt.executeQuery("SELECT * FROM member where id='"+id+"'");
		 ...
		 counter = stmt.executeUpdate("update member set passwd='"+passwd+"', name='"+name+"',mem_num1='"+mem_num1+"',mem_num2='"+mem_num2+"',e_mail='"+e_mail+"',phone='"+phone+"',zipcode='"+zipcode+"',address='"+address+"',job='"+job+"' where id = '"+id+"';");
%>
	<script>
